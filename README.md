...
legacy-интерфейсом `New/`. Первый срез содержит восемь семейств `5/9`, имеющих
символьные сертификаты в `magic-squares-core`, а также статический раздел
новостей без отдельной серверной части.
