...
export const NEWS: readonly NewsArticle[] = [
  {
    ...
    summary:
      "Миниатюры показывают доказательные опоры клеток, а страницы семейств содержат полный последовательный LaTeX-текст доказательства.",
    ...
    body: [
      ...
      "У каждого семейства появилась отдельная страница с явными корнями, выводом цветовых тождеств, восстановлением E, x, y, разбором целочисленности и ссылками на общие леммы. Все стартовые пресеты дают девять положительных попарно различных клеток и ровно заявленные пять квадратов.",
    ],
  },
  {
